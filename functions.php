...
function theme_styles() {
  wp_register_style( 'google-fonts', 'http://fonts.googleapis.com/css?family=Merriweather|Open+Sans+Condensed:400', array(), '20130425', 'all' );
...
function ttext_customize ($wp_customize) {
	...
	$wp_customize->add_setting( 'ga_setting', array( 'default' => 'UA-1421028-69' ) );
